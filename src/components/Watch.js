...
const Watch = () => {
    ...
    return (
        <div className='flex ml-20 w-[100%] mt-2' style={{ marginTop: '-50px' }}>
                ...
                <div>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex items-center w-[40%] justify-between mt-2'>
                            ...
                            <div className='flex items-center cursor-pointer bg-gray-200 px-4 py-2 rounded-full' onClick={handleShare} >
                            ...
                            <div className='flex items-center cursor-pointer bg-gray-200 px-5 py-2 rounded-full'>
                                <a href={`https://www.youtube.com/watch?v=${videoId}`} download>
                                    <GoDownload />
                                    <span>Download</span>
                                </a>
                            </div>
